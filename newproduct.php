            ...
            <div class="row ">
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center ">
                    <div class="product-top ">
                        <a href="item.php"><img class="img-fluid" src="http://demo.templatin.com/megashop17/2-home_default/galaxy-noteseries-smartphone.jpg "></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center ">
                    <div class="product-top ">
                        <a href="item.php"><img class="img-fluid " src="http://demo.templatin.com/megashop17/15-home_default/monitor-with-wide-viewing-ange.jpg"></a>
