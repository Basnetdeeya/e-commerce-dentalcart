...
<nav class="navbar navbar-expand-lg navbar-light sticky-top naav">
        <div class="container">
            <li class="nav-item dropdown bg-danger text-center">
                <a class="nav-link dropdown-toggle m-0" href="healthcare.php" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Categories
                </a>
    ...
    <div class="products my-5 ">
        ...
        <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-black" href="/">Categories</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Health Care</li>
                </ol>
            </nav>
            <div class=" title d-flex justify-content-between align-items-center">
                <h1 class=" sale-head ">Health Care </h1>
            </div>
            <div class="row ">
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center ">
                    <div class="product-top ">
                        <img class="img-fluid " src="images/hc.jpg" height="180" width="230">
                    ...
                    <div class="product-bottom align-items-center mb-3 " title="Rating ">
                        <h6 class="text-center text-black fw-bold ">Health Care</h6>
                        <h5 class="my-3 text-center ">RS.1,000</h5>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center ">
                    <div class="product-top ">
                        <img class="img-fluid " src="images/hc4.jpg" height="180" width="230">
                    ...
                    <div class="product-bottom align-items-center mb-3 " title="Rating ">
                        <h6 class="text-center text-black fw-bold ">Health Care</h6>
                        <h5 class="my-3 text-center ">RS.500</h5>
                        <div class="icon text text-center ">
                            <i class="fas fa-star "></i>
                            <i class="fas fa-star "></i>
                            <i class="fas fa-star "></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center ">
                    ...
                    <div class="product-bottom align-items-center mb-3 " title="Rating ">
                        <h6 class="text-center text-black fw-bold ">Health Care</h6>
                        <h5 class="my-3 text-center ">RS.800</h5>
                        <div class="icon text text-center ">
                            <i class="fas fa-star "></i>
                            <i class="fas fa-star "></i>
                            <i class="fas fa-star "></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center ">
                    ...
                    <div class="product-bottom align-items-center mb-3 " title="Rating ">
                        <h6 class="text-center text-black fw-bold ">Health Care</h6>
                        <h5 class="my-3 text-center ">RS.2,000</h5>
                        <div class="icon text text-center ">
                            <i class="fas fa-star "></i>
                            <i class="fas fa-star "></i>
                            <i class="fas fa-star "></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center mt-5">
                    <div class="product-top ">
                        <img class="img-fluid " src="images/hc.jpg" height="180" width="230">
                    ...
                    <div class="product-bottom align-items-center mb-3 " title="Rating ">
                        <h6 class="text-center text-black fw-bold ">Health Care</h6>
                        <h5 class="my-3 text-center ">RS.10,000</h5>
                        <div class="icon text text-center ">
                            <i class="fas fa-star "></i>
                            <i class="fas fa-star "></i>
                            <i class="fas fa-star "></i>
