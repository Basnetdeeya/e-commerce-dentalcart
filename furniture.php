...
<nav class="navbar navbar-expand-lg navbar-light sticky-top naav">
        <div class="container">
            <li class="nav-item dropdown bg-danger text-center">
                <a class="nav-link dropdown-toggle m-0" href="furniture.php" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Categories
                </a>
    ...
    <div class="products my-5 ">
        ...
        <nav aria-label="breadcrumb">
            ...
            <div class=" title d-flex justify-content-between align-items-center">
                <h1 class=" sale-head ">Furniture </h1>
            </div>
            <div class="row ">
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center ">
                    <div class="product-top ">
                        <img class="img-fluid " src="images/television.jpg ">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center mt-5">
                    <div class="product-top ">
                        <img class="img-fluid " src="images/monitor-with-wide-viewing-angle.jpg">
