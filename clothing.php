...
<nav class="navbar navbar-expand-lg navbar-light sticky-top naav">
        <div class="container">
            <li class="nav-item dropdown bg-danger text-center">
                <a class="nav-link dropdown-toggle m-0" href="clothing.php" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Categories
                </a>
            ...
            <div class="row ">
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center ">
                    <div class="product-top ">
                        <img class="img-fluid " src="images/women-cotton-blend-trousers.jpg ">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 hvr-grow p-0 text-center mt-5">
                    <div class="product-top ">
                        <img class="img-fluid " src="images/womens-collection.jpg">
